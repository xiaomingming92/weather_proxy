...
export const QWEATHER_TO_ACCUWEATHER_MAP: Record<string, AccuWeatherCode> = {
  ...
  // 雾/霾
  '500': '8', // 薄雾 -> Fog
  '501': '8', // 雾 -> Fog (修正：原映射为5太阳图标错误)
  '502': '8', // 霾 -> Fog (修正：原映射为5太阳图标错误)
  '503': '8', // 浓雾 -> Fog (修正：原映射为5太阳图标错误)
  '504': '8', // 强浓雾 -> Smoke (修正：原映射为5太阳图标错误)
  ...
  '514': '8', // 大雾 -> Dense Fog
  '515': '8', // 特强浓雾 -> Extreme Fog
  // 风
  '600': '2', // 轻风
  '601': '2', // 微风
  '602': '2', // 和风
  // 沙尘
  '800': '19', // 浮尘 -> Dust (修正：原映射为35多云图标错误)
  '801': '52', // 扬沙 -> Haze (修正：原映射为35多云图标错误)
