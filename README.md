...
本项目为个人对**自有老旧设备**的技术研究与数字保育（digital preservation）实践，**纯非商业**，不提供任何付费或托管服务。所涉逆向分析仅用于设备互操作性研究；天气数据来自使用者**自行申请的和风天气 API Key**，不涉及对上游服务的盗用或转售。仓库内经修改的 APK 仅供**调试与互操作研究**，请勿用于商业分发或任何侵犯第三方权利的用途。使用者应对自身行为及所在司法辖区的合规性负责。
...
项目已在 XDA 论坛发帖，欢迎搞机同好交流、反馈、晒复活成果：
