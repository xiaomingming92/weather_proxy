...
// 多路径回退：weather_proxy 双库环境，add-prisma 优先
const candidates = [
  ...
  (() => { const d = dirname(fileURLToPath(import.meta.url)); const root = pathResolve(d, "..", "..", "..", ".."); return join(root, "src/generated/add-prisma/client.ts") })(),
  (() => { const d = dirname(fileURLToPath(import.meta.url)); const root = pathResolve(d, "..", "..", "..", ".."); return join(root, "src/generated/add-prisma/client.js") })(),
